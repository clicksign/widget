...
(function() {
  var HEIGHT, HOST, PROTOCOL, TIMEOUT, WIDTH, addEventListener, attach_element, callback_fn, callback_registered, configure, createElement, create_iframe, getElementById, host_for, origin, path_for, protocol_for, query_for, timeout_for, window;
  ...
  addEventListener = function(callback) {
    ...
    return callback_registered = true;
  };
